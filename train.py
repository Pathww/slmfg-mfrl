...
parser.add_argument('--env-name', type=str, default='explore', help='Experiment name')
...
parser.add_argument('--min-agent-num', type=int, default=2, help='Number of agents')
parser.add_argument('--max-agent-num', type=int, default=200, help='Number of agents')
